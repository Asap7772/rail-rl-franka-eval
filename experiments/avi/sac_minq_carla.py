...
DEFAULT_BUFFER_PATH = '/nfs/kun1/users/aviralkumar/PythonAPI/carla-town04-48x48-fov48-mutiagent-100k-2020-05-15-10-43-31'
...
def experiment(variant):
    expl_env = carla_env.CarlaObsDictEnv(carla_port=variant['carla_port'], args=variant['env_args'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--buffer", type=str, default=DEFAULT_BUFFER_PATH)
    ...
    parser.add_argument("--policy_eval_start", default=10000, type=int)
    ...
    variant['trainer_kwargs']['use_projected_grad'] = False
    variant['trainer_kwargs']['max_q_backup'] = False
    variant['trainer_kwargs']['deterministic_backup'] = True
    ...
    variant['carla_port'] = args.carla_port

    # import ipdb; ipdb.set_trace()
    n_seeds = 1
    mode = 'here_no_doodad'
    exp_prefix = 'carla_railrl/railrl-CQL-carla-{}-pixel'.format(args.env)
