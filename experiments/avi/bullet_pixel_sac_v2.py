...
def experiment(variant):
    ...
    expl_env = roboverse.make(
        variant['env'], gui=False, randomize=variant['randomize_env'],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--obs", required=True, type=str,
                        choices=('pixels', 'pixels_debug'))
    parser.add_argument("--gpu", type=int, default=1)
    parser.add_argument("--save-buffer", type=int, default=1)
    ...
    if 'V2-v0' in variant['env'] or 'V3-v0' in variant['env']:
        ...
        variant['dump_video_kwargs']['save_video_period'] = 100
