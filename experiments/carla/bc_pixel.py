...
DEFAULT_BUFFER = os.path.expanduser('~/.d4rl/datasets/carla_lane_follow-v0.hdf5')
...
def experiment(variant):
    ...
    load_hdf5(variant['buffer'], replay_buffer)
...
if __name__ == "__main__":
    ...
    mode = 'local'
    mode = 'here_no_doodad'
    exp_prefix = 'railrl-BC-carla-{}-{}'.format(args.env, args.obs)
